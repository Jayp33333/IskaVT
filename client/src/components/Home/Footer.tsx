      ...
      <div className="container relative mx-auto">
        <div className="mb-10 grid grid-cols-1 gap-8 sm:mb-12 sm:gap-10 lg:mb-16 lg:grid-cols-2 lg:gap-12">
              ...
              {socialLinks.map((item, i) => {
                ...
                return (
                  <motion.a
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-lg border border-ink bg-white text-ink shadow-brutal-sm transition-colors hover:border-ink hover:bg-ink hover:text-white sm:h-11 sm:w-11 sm:rounded-xl"
                  >
          ...
          <div className="relative">
            <div className="relative z-10 rounded-2xl border border-ink bg-white p-5 shadow-brutal-md sm:rounded-3xl sm:p-6 lg:p-8">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
                <input
                  ...
                  className="flex-1 rounded-lg border border-ink bg-muted p-3 text-sm font-bold text-ink outline-none transition-colors placeholder:text-ink/30 focus:border-maroon focus:bg-white sm:rounded-xl sm:p-3.5 sm:text-base"
                />
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 rounded-lg border border-ink bg-maroon px-5 py-3 text-[10px] font-black uppercase tracking-tighter text-white shadow-brutal-sm transition-colors hover:bg-maroon/90 sm:rounded-xl sm:px-6 sm:py-3.5 sm:text-xs"
                >
