    ...
    <div className="space-y-8 sm:space-y-10">
      {hymnContent.map((hymn, hymnIndex) => (
        <motion.article
          ...
          className="overflow-hidden rounded-2xl border-2 border-black bg-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] sm:rounded-3xl sm:border-4"
        >
          <div className="border-b-2 border-black bg-[#800000] px-5 py-4 sm:border-b-4 sm:px-6 sm:py-5">
